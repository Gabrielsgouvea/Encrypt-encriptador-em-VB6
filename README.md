...
Este projeto é um aplicativo desenvolvido em VB6 que permite criptografar mensagens convertendo texto em representação binária (0 e 1), utilizando uma chave numérica entre 0 e 255.
